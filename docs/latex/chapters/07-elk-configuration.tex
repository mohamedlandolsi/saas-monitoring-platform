...
\begin{lstlisting}[caption={Elasticsearch Environment Configuration}]
environment:
...
\begin{lstlisting}[caption={Elasticsearch Index Template}]
...
\begin{lstlisting}[caption={Kibana Configuration}]
environment:
