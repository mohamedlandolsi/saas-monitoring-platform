...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}\textit{[Screenshot: Main Dashboard]}\\\texttt{http://localhost:5000}\vspace{3cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}\textit{[Screenshot: File Upload Page]}\\\texttt{http://localhost:5000/upload}\vspace{3cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}\textit{[Screenshot: Search Interface]}\\\texttt{http://localhost:5000/search}\vspace{3cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}\textit{[Screenshot: Live Logs Page]}\\\texttt{http://localhost:5000/live}\vspace{3cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}\textit{[Screenshot: Grafana Dashboard]}\\\texttt{http://localhost:3000}\vspace{3cm}}}
