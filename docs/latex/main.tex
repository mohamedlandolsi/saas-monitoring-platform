...
\input{chapters/02-global-architecture}
\input{chapters/03-detailed-architecture}
...
\input{chapters/04-technologies}
\input{chapters/05-modules}
\input{chapters/06-code-excerpts}
\input{chapters/07-elk-configuration}
\input{chapters/08-data-models}
...
\input{chapters/09-installation-guide}
\input{chapters/10-user-guide}
\input{chapters/11-testing-validation}
\input{chapters/12-challenges-solutions}
\input{chapters/13-future-improvements}
